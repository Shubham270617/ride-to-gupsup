...
export default function EventCard({ event, featured = false }) {
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            ...
            <span className="flex items-center gap-2 text-sm font-semibold text-rtg-orange-300"><Tag size={16} /> {event.prize}</span>
          </div>
        </div>
      </motion.div>
    );
  ...
  return (
    <GlassCard className="p-0 overflow-hidden group cursor-pointer" hover>
